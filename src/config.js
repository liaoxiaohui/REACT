...
// esriConfig.request.proxyUrl = `http://${ApiConfigure.IP_Main}:${ApiConfigure.Port_Main}/Java/proxy.jsp`;
// esriConfig.workers.loaderUrl = DEFAULT_LOADER_URL;

//这里配置proxy代理的规则,有多少个地图服务就配置多少个rule
// const rule = {
//   urlPrefix: ApiConfigure.mapServer,
//   proxyUrl: ApiConfigure.proxyUrl
// };
// const rule2 = {
//   urlPrefix: "tiles.arcgis.com",
//   proxyUrl: ApiConfigure.proxyUrl
// };
// esriConfig.request.proxyRules.push(rule, rule2);
////配置proxy代理规则结束
esriConfig.workers.loaderUrl = DEFAULT_LOADER_URL;
